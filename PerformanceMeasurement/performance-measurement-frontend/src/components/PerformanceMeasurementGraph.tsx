...
import { BenchMarkData, BenchmarkResults } from "../data/dummyData";

function PerformanceMeasurementGraph({ data }: { data: BenchMarkData }) {
  const ref = useRef<SVGSVGElement | null>(null);

  useEffect(() => {
    const tooltip = d3.select("#tooltip");

    const customData: BenchmarkResults = data.customConcurrentHashMap10.results;
    const javaData: BenchmarkResults = data.javaConcurrentHashMap10.results;
...
export default PerformanceMeasurementGraph;
